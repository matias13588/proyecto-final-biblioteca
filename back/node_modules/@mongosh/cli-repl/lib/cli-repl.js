...
class CliRepl {
    ...
    async start(driverUri, driverOptions) {
        ...
        const commandLineLoadFiles = (_c = this.cliOptions.fileNames) !== null && _c !== void 0 ? _c : [];
        const evalScripts = (_d = this.cliOptions.eval) !== null && _d !== void 0 ? _d : [];
    ...
    setupAnalytics() {
        ...
        const apiKey = (_c = (_b = this.analyticsOptions) === null || _b === void 0 ? void 0 : _b.apiKey) !== null && _c !== void 0 ? _c : require('./build-info.json').segmentApiKey;
